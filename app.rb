...
get '/display_record/:id' do
  ...
  output +='<a href="/about">&#62About</a>'
  output +='<a href="/contact">&#62Contact</a>'
  output +='<a style="text-align:right;position:relative;left:750" href="/display_record/#{(params[:page].to_i + 1)}">&#62Next</a>
...
form = ""
  ...
  form +="<p><label>Languages to be Translated</label><select name='hasLanguage'><option value='#{thisEdit.hasLanguage}>#{thisEdit.hasLanguage}</option><option value='Arabic'>Arabic</option><option value='Russian'>Russian</option><option value='Both'>Both</option></select></p>"
