...
form = ""
  ...
  form +="<p><label>Languages to be Translated</label><select name='hasLanguage'><option value='arabic'>Arabic</option><option value='russian'>Russian</option><option value='both'>Both</option><option value='none'>None</option></select></p>"
