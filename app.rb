...
form = ""
  ...
  form +="<p><label>Languages to be Translated</label><select name='hasLanguage' selectedvalue='#{thisEdit.hasLanguage}'><option value='Arabic'>Arabic</option><option value='Russian'>Russian</option><option value='Both'>Both</option></select></p>"
